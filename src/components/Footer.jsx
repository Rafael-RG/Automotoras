    ...
    <div className="px-4 md:px-12 py-10 w-full max-w-screen-2xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-10">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[#E5E2E3]/55 text-xs max-w-xs leading-relaxed">
        ...
        <div className="flex flex-wrap gap-8 md:gap-16">
          <div className="flex flex-col gap-3">
            ...
            <a href="/" className="text-[#E5E2E3]/65 hover:text-[#E5E2E3] text-xs transition-colors">Garage</a>
            <a href="/dealerships" className="text-[#E5E2E3]/65 hover:text-[#E5E2E3] text-xs transition-colors">Buscar Automotoras</a>
            <a href="/sobre-nosotros" className="text-[#E5E2E3]/65 hover:text-[#E5E2E3] text-xs transition-colors">Sobre RedAutos</a>
          </div>
          <div className="flex flex-col gap-3">
            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-primary mb-1">Legal</p>
            <a href="/privacidad" className="text-[#E5E2E3]/65 hover:text-[#E5E2E3] text-xs transition-colors">Privacidad</a>
          </div>
          <div className="flex flex-col gap-3">
            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-primary mb-1">Automotoras</p>
            <a href="/unirse" className="text-[#E5E2E3]/85 hover:text-[#E5E2E3] text-xs transition-colors">Sumá tu automotora</a>
            <a href="/sobre-nosotros" className="text-[#E5E2E3]/65 hover:text-[#E5E2E3] text-xs transition-colors">Sobre RedAutos</a>
            <a href="/login" className="text-[#E5E2E3]/65 hover:text-[#E5E2E3] text-xs transition-colors flex items-center gap-1.5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              className="text-[#E5E2E3]/65 hover:text-primary text-xs font-bold transition-colors flex items-center gap-2"
            >
            ...
            <a
              ...
              className="text-[#E5E2E3]/55 hover:text-primary text-[10px] transition-colors"
            >
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-2">
        <p className="text-[#E5E2E3]/60 text-[10px] tracking-[0.15em] uppercase">
