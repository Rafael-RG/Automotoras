          ...
          <section className="px-4 md:px-8 max-w-screen-2xl mx-auto mt-12">
            ...
            <div className="bg-[#131314] border border-[#E5E2E3]/10 rounded-xl p-4 md:p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-6 hover:border-[#D32F2F]/30 transition-colors">
              ...
              <div className="flex flex-row sm:flex-col gap-2 flex-shrink-0 w-full sm:w-auto">
                ...
                <Link
                  to="/dealerships"
                  className="flex items-center gap-2 bg-[#E5E2E3]/5 text-[#E5E2E3]/50 border border-[#E5E2E3]/10 px-4 py-2 rounded-lg text-xs font-bold hover:border-[#E5E2E3]/20 hover:text-[#E5E2E3]/70 transition-colors"
                >
                ...
                <Link
                  ...
                  className="flex items-center gap-2 bg-primary/10 text-primary border border-primary/20 px-4 py-2 rounded-lg text-xs font-bold hover:bg-primary/20 transition-colors"
                >
